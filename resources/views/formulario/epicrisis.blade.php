                ...
                <tr>
                  <td style="text-align: center;">
                    <label class="radio-inline">
                      <div class="iradio_square-blue" aria-checked="false" aria-disabled="false" style="position: relative;"><input type="radio" name="psicoterapia" class="square center" value="1" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>
                    </label>
                  </td>
                  <td style="text-align: center;">
                    <label class="radio-inline">
                      <div class="iradio_square-blue" aria-checked="false" aria-disabled="false" style="position: relative;"><input type="radio" name="psicoterapia" class="square center" value="2" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>
                    </label>
                  </td>
                  <td style="text-align: center;">
                    <label class="radio-inline">
                      <div class="iradio_square-blue" aria-checked="false" aria-disabled="false" style="position: relative;"><input type="radio" name="psicoterapia" class="square" value="3" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>                   
                    </label>
                  </td>
                  <td style="text-align: center;">
                    <label class="radio-inline">
                      <div class="iradio_square-blue" aria-checked="false" aria-disabled="false" style="position: relative;"><input type="radio" name="psicoterapia" class="square" value="4" required="" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>
                    </label>
                  </td>
                    ...
                    <label>Otro:</label>      
                  <input type="text" name="otro" class="form-control" placeholder="Especificaciones breves ..." maxlength="150">                  
  <hr>
  <label>Diagnóstico (DSM IV por ejes)</label>       
  <input type="text" name="DSM1" class="form-control" placeholder="1.-" maxlength="150" required="" pattern="[A-Z]{0-150}">
  <input type="text" name="DSM2" class="form-control" placeholder="2.-" maxlength="150" required="" pattern="[A-Z]{0-150}">
  <input type="text" name="DSM3" class="form-control" placeholder="3.-" maxlength="150" required="" pattern="[A-Z]{0-150}">
  <input type="text" name="DSM4" class="form-control" placeholder="4.-" maxlength="150" required="" pattern="[A-Z]{0-150}">
  <input type="text" name="DSM5" class="form-control" placeholder="5.-" maxlength="150" required="" pattern="[A-Z]{0-150}">
                    
  <hr>
                    <label>Interconsultas o derivaciones</label>                  
                  <textarea name="interconsulta" input type="text" class="form-control" rows="3" ></textarea>
<hr>                   
                   <label>Psicodiagnóstico o test administrados</label>              
                  <textarea name="psicodiag" input type="text" class="form-control" rows="3" ></textarea>
<hr>
                  <label>Resumen del logro de tratamiento</label>                  
                  <textarea name="resumen" input type="text" class="form-control" rows="6" ></textarea>

<hr>
                  <label>Evaluación del logro de las metas</label>                  
                  <textarea name="metas" input type="text" class="form-control" rows="3" ></textarea>
<hr>
                  <label>Comentarios finales</label>                  
                  <textarea name="comentarios" input type="text" class="form-control" rows="3"></textarea>
